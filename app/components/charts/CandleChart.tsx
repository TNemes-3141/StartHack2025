...
import { apexAxisSeriesConverter, AxisChartDataList } from './ApexSeriesConverter';
...
const CandlestickChart = ({
  ...
  return (
    <div className="candlestick-chart">
      <ReactApexChart options={options} series={ dataList ? apexAxisSeriesConverter(dataList) : apexAxisSeriesConverter(candle_data_list) } type="candlestick" height={250} />
    </div>
  );
};
